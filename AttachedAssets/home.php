...
if (!$isAdminUser) {
    ...
    $stmtKPI = $conn->prepare("
        SELECT category, AVG(actual_value) as actual_value, AVG(target_value) as target_value
        FROM kpi 
        WHERE period_month = :month AND period_year = :year
        GROUP BY category
    ");
    $stmtKPI->execute([':month' => $currentMonth, ':year' => $currentYear]);
    $kpiData = $stmtKPI->fetchAll();
}
    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            <div class="row g-3 mb-4">
                ...
                <div class="col-md-3">
                    <a href="overtime.php" class="text-decoration-none">
                        <div class="card shortcut-card h-100 text-center p-3">
                            ...
                            <h6 class="mt-2 mb-0">Overtime</h6>
                ...
                <div class="col-md-3">
                    <a href="leave.php" class="text-decoration-none">
                        <div class="card shortcut-card h-100 text-center p-3">
                            ...
                            <small class="text-muted">Cuti/Izin</small>
                        </div>
                    </a>
                </div>
                <div class="col-md-3">
                ...
                <?php else: ?>
                <div class="col-md-3">
                    <a href="overtime_admin.php" class="text-decoration-none">
                        <div class="card shortcut-card h-100 text-center p-3">
                            <i class="bi bi-clock text-warning" style="font-size: 2.5rem;"></i>
                            <h6 class="mt-2 mb-0">Overtime</h6>
                            <small class="text-muted">Kelola Lembur</small>
                        </div>
                    </a>
                </div>
                <div class="col-md-3">
                    <a href="leave_admin.php" class="text-decoration-none">
                        <div class="card shortcut-card h-100 text-center p-3">
                            <i class="bi bi-calendar-x text-danger" style="font-size: 2.5rem;"></i>
                            <h6 class="mt-2 mb-0">Leave</h6>
                ...
                <div class="col-md-3">
                    <a href="inbox_compose.php" class="text-decoration-none">
                        <div class="card shortcut-card h-100 text-center p-3">
                            <i class="bi bi-envelope-plus text-info" style="font-size: 2.5rem;"></i>
                            <h6 class="mt-2 mb-0">Compose</h6>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    if (!$isAdminUser) {
                        ...
                        $stmtLeave = $conn->prepare("SELECT COUNT(*) as count FROM leave_requests WHERE status = 'PENDING'");
                        $stmtLeave->execute();
                        $pendingLeave = $stmtLeave->fetch()['count'];
